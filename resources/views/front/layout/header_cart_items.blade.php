...
<div class="mini-cart-wrapper">
        <div class="mini-cart">
            ...
            <ul class="mini-cart-list">
                ...
                @php $getDiscountAttributePrice = Product::getDiscountAttributePrice($item['product_id'], $item['size']); @endphp
                <li class="clearfix">
                    <a href="{{ route('product', ['id' => $item['product_id']]) }}">
                        ...
                        <span class="mini-item-price">Rs.{{ number_format($getDiscountAttributePrice['product_price']) }}</span>
            ...
            <div class="mini-shop-total clearfix">
                ...
                <span class="mini-total-price float-right">Rs.{{ number_format($total_price) }}</span>
            </div>
