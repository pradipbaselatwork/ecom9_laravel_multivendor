                    ...
                    <div class="login-wrapper">
                        ...
                        <form id="forgotForm" action="javascript:void(0);" method="post">
                            ...
                            <div class="u-s-m-b-30">
                                ...
                                <input type="email" name="email" id="users-email" class="text-field" placeholder="Username / Email">
                                <p id="forgot-email"></p>
                            </div>
                            ...
                            <div class="m-b-45">
                                <button class="button button-outline-secondary w-100">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="reg-wrapper">
                        ...
                        <form id="registerForm" action="javascript:void(0);" method="POST">
                            ...
                            <div class="u-s-m-b-45">
                                <button type="submit" id="registerButton" class="button button-primary w-100">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
