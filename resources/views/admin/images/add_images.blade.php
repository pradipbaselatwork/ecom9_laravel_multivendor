                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="forms-sample" action="{{ url('admin/add-images/'.$products['id']) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    @if (!empty($products['product_image']))
                                        <img style="width: 120px"  src="{{ url('front/images/product_images/small/'.$products['product_image']) }}">
                                    @else
                            ...
                            {{-- <form class="forms-sample" action="{{ url('admin/edit-attribute/'.$products['id']) }}" method="post"> --}}
                                {{-- @csrf --}}
                            <table id="bootstrap-4-datatables" class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($products['images'] as $image)
                                     <input style="display: none;" type="text" name="attributeId[]" value="{{ $image['id'] }}">
                                        <tr>
                                            <td>
                                                {{ $image['id'] }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                &nbsp;
                                                <a href="javascript:void(0)" class="confirmDelete" module="image" moduleid="{{ $image['id'] }}" href="{{ url('admin/delete-image/'.$image['id']) }}"><i
