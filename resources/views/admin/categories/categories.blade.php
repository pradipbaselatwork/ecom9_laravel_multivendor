                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a style="max-width: 150px; float:right; display:inline-block;" href="{{ route('admin.add-edit-category') }}" class="btn btn-block btn-primary">Add Category</a>
                                ...
                                <table id="bootstrap-4-datatables" class="table table-bordered">
                                    ...
                                    <tbody>
                                       ...
                                       @php $parent_category = $category['parentcategory']['category_name']  @endphp
                                          @else
                                        @php $parent_category = "Root"; @endphp @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0)" class="confirmDelete" module="category" moduleid="{{ $category['id'] }}" href="{{ url('admin/delete-category/'.$category['id']) }}"><i
