                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a style="max-width: 150px; float:right; display:inline-block;" href="{{ route('admin.add-edit-coupon') }}" class="btn btn-block btn-primary">Add Coupons</a>
                                        ...
                                        @foreach ($coupons as $coupon)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0)" class="confirmDelete" module="coupon" moduleid="{{ $coupon['id'] }}" href="{{ url('admin/delete-coupon/'.$coupon['id']) }}"><i
