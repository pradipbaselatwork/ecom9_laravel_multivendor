                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a style="max-width: 150px; float:right; display:inline-block;" href="{{ route('admin.add-edit-brand') }}" class="btn btn-block btn-primary">Add Brands</a>
                                        ...
                                        @foreach ($brands as $brand)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0)" class="confirmDelete" module="brand" moduleid="{{ $brand['id'] }}" href="{{ url('admin/delete-brand/'.$brand['id']) }}"><i
